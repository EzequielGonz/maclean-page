  ...
  return (
    <html lang="es">
      <head>
        ...
        <Script async src="https://www.googletagmanager.com/gtag/js?id=AW-17452083035" strategy="afterInteractive" />
        <Script id="google-tag" strategy="afterInteractive">
          {`
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
            gtag('config', 'AW-16450971236', { 'allow_enhanced_conversions': true });
            gtag('config', 'AW-17452083035', { 'allow_enhanced_conversions': true });
          `}
        </Script>
      </head>
